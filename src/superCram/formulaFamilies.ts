...
const family = (
  ...
  cheatSheetSections: readonly CheatSheetSectionId[],
...
/**
 * Formula Application is an application lane, not a style label. These
 * operations record the actual work expected by each curated question form.
 * A question with only "select-formula" would be recognition and is rejected
 * by the registry validator.
 */
const formulaApplicationOperationsByQuestionId: Readonly<
  Record<string, readonly FormulaApplicationOperation[]>
> = Object.freeze({
  "auth-form-ch01-011": ["extract-inputs", "calculate", "sign-or-units"],
  "auth-ch01-005": ["extract-inputs", "substitute", "calculate"],
  "auth-form-ch01-012": ["extract-inputs", "substitute", "calculate"],
  "auth-form-ch02-012": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-ch03-001": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-stim-ch03-003": ["extract-inputs", "substitute", "calculate"],
  "auth-form-ch03-011": ["select-formula", "substitute", "calculate"],
  "auth-form-ch03-012": [
    "select-formula",
    "extract-inputs",
    "calculate",
  ...
  "auth-ch03-008": ["select-formula", "substitute", "calculate"],
  "auth-form-ch03-013": ["select-formula", "substitute", "calculate"],
  "auth-ch04-004": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-ch04-007": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-stim-ch04-003": ["select-formula", "extract-inputs", "calculate"],
  "auth-form-ch04-011": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-ch05-001": ["select-formula", "substitute", "calculate"],
  "auth-form-ch05-012": ["extract-inputs", "calculate"],
  "auth-form-ch05-013": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-form-ch05-014": ["select-formula", "extract-inputs", "calculate"],
  "auth-form-ch05-015": ["select-formula", "rearrange", "calculate"],
  "auth-ch05-009": ["select-formula", "substitute", "calculate"],
  "auth-ch05-011": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-stim-ch05-003": ["extract-inputs", "substitute", "calculate"],
  "auth-form-ch05-016": [
    "select-formula",
    "extract-inputs",
    "calculate",
  ...
  "auth-form-ch06-013": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-ch06-001": ["select-formula", "substitute", "calculate"],
  "auth-ch06-002": ["select-formula", "substitute", "calculate"],
  "auth-ch07-004": ["select-formula", "extract-inputs", "calculate", "sign-or-units"],
  "auth-form-ch07-013": [
    "select-formula",
    "extract-inputs",
    "calculate",
  ...
  "auth-ch08-001": ["select-formula", "substitute", "calculate"],
  "auth-ch08-003": ["select-formula", "rearrange", "calculate", "sign-or-units"],
  "auth-form-ch08-012": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-form-ch08-013": ["select-formula", "rearrange", "substitute", "calculate"],
  "auth-form-ch08-014": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-ch09-005": ["select-formula", "extract-inputs", "substitute", "calculate"],
  "auth-ch09-006": ["select-formula", "extract-inputs", "substitute", "calculate"],
  "auth-form-ch09-016": ["select-formula", "extract-inputs", "substitute", "calculate"],
  "auth-ch09-013": ["select-formula", "extract-inputs", "calculate", "sign-or-units"],
  "auth-form-ch09-014": [
    "select-formula",
    "extract-inputs",
    "calculate",
  ...
  "auth-form-ch09-015": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-ch10-006": ["select-formula", "substitute", "calculate"],
  "auth-form-ch10-015": ["select-formula", "extract-inputs", "substitute", "calculate"],
  "auth-form-ch10-013": ["select-formula", "substitute", "calculate", "sign-or-units"],
  "auth-form-ch10-014": ["select-formula", "substitute", "calculate"],
  "auth-stim-ch10-003": ["select-formula", "extract-inputs", "calculate"],
