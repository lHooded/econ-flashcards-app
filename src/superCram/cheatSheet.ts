...
export const cheatSheetSkillProfiles: readonly CheatSheetSkillProfile[] = Object.freeze(
  [
    profile(
      "critical-ad-as-self-correction",
      5,
      ["8C", "8E", "8F", "T4"],
      "reasoning-heavy",
    ),
    ...
    profile("critical-ad-prf-quantitative-chain", 3, ["8A", "8B", "8D", "Q3"], "mixed"),
    profile(
    ...
    profile("critical-loop-ppp-relative-inflation", 3, ["9E", "9J", "Q2"], "mixed"),
    profile("critical-bop-current-account", 3, ["9A", "9H", "9J"], "mixed"),
    profile(
    ...
    profile(
      "critical-speculative-attack-defence",
      5,
      ["9F", "9I", "T3"],
      "reasoning-heavy",
    ),
    ...
    profile("critical-trade-weighted-index", 4, ["9G", "9J"], "reasoning-heavy"),
    profile(
    ...
    profile(
      "very-high-bank-deposit-creation",
      5,
      ["6C", "6E", "6F"],
      "reasoning-heavy",
    ),
    profile("very-high-bank-risk-chain", 5, ["6B", "6F", "T2"], "reasoning-heavy"),
    profile("very-high-money-destruction", 4, ["6C", "6E"], "reasoning-heavy"),
    profile("very-high-prf-taylor", 4, ["7C", "7E", "Q2"], "reasoning-heavy"),
    profile("very-high-zlb-deflation-fisher", 5, ["7D", "7F", "T4"], "reasoning-heavy"),
    profile(
    ...
    profile("very-high-cash-rate-security-market", 4, ["6D", "7F"], "reasoning-heavy"),
    profile("very-high-small-open-fiscal", 4, ["9A", "9B", "Q2"], "reasoning-heavy"),
    profile("very-high-rba-corridor-omo", 3, ["7A", "7E", "T2"], "mixed"),
    profile("very-high-growth-convergence", 4, ["10G", "10H"], "reasoning-heavy"),
    profile("core-gdp-value-added", 1, ["1A", "1B", "1E", "Q1"], "direct-lookup"),
    profile("core-cpi-inflation-deflation", 1, ["1C", "1E", "Q1"], "direct-lookup"),
    profile("core-labour-wage-floor", 4, ["2A", "2C", "2D", "2E"], "reasoning-heavy"),
    profile(
    ...
    profile("core-investment-user-cost", 3, ["3B", "3E", "T1", "Q3"], "mixed"),
    profile(
    ...
    profile("core-bond-price-yield", 2, ["6A", "Q3"], "lookup-plus-application"),
