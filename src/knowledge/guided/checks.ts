...
const skills: readonly GuidedKnowledgeCheckSkill[] = [
  ...
  mcqPair(
    ...
    },
    {
      ...
      choices: [
        "Quantity sold",
        "The price of one loaf",
        "The bakery's opening time",
        "The baker's name",
      ],
      correctChoice: 0,
      explanation:
  ...
  mcqPair(
    ...
    ["asset", "flow"],
    {
      ...
      choices: [
        "Lending",
        "A gift with no repayment",
        "Buying something for immediate use",
  ...
  mcqPair(
    ...
    ["gross-domestic-product", "income", "value-added"],
    {
      ...
      choices: [
        ...
        "Only the bakery's opening hours",
